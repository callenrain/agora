...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Presenter.name'
        db.delete_column(u'archives_presenter', 'name')

        # Adding field 'Presenter.first_name'
        db.add_column(u'archives_presenter', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Presenter.last_name'
        db.add_column(u'archives_presenter', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Presenter.name'
        db.add_column(u'archives_presenter', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'Presenter.first_name'
        db.delete_column(u'archives_presenter', 'first_name')

        # Deleting field 'Presenter.last_name'
        db.delete_column(u'archives_presenter', 'last_name')
