...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Presenter.video'
        db.alter_column(u'archives_presenter', 'video', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Presenter.video'
        db.alter_column(u'archives_presenter', 'video', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
